...
WEBHOOK_URL = os.getenv("WEBHOOK_URL")  # לדוגמה: https://your-app-name.onrender.com/webhook
...
async def cleanup(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("כל ההודעות נמחקו בהצלחה!")
    except Exception as e:
...
async def webhook(update: Update, context: ContextTypes.DEFAULT_TYPE):
    # טיפול בעדכונים שנשלחים דרך webhook
    if update.message:
